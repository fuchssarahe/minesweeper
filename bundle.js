...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    ...
	    Minesweeper = __webpack_require__(168);
	...
	var Game = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(Modal, { modalActive: this.state.modalActive, restartGame: this.restartGame }),
	    ...
	    var grid = this.props.board.grid.map(function (row, rowIdx) {
	      return React.createElement(
	        ...
	        row.map(function (tile, colIdx) {
	          return React.createElement(Tile, { tileObject: tile, updateGame: _this.props.updateGame, key: [rowIdx, colIdx] });
	        })
	      );
	    });
	...
	var Tile = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { className: tileClass, onClick: this.reveal },
	      tileText
	    );
	  }
	});
